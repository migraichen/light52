...
S:Lport.pxPortInitialiseStack$pxCode$1_0$97({2}DC,DF,SV:S),B,1,-4
S:Lport.pxPortInitialiseStack$pvParameters$1_0$97({3}DG,SV:S),B,1,-7
S:Lport.pxPortInitialiseStack$pxTopOfStack$1_0$97({3}DG,SC:U),R,0,0,[r5,r6,r7]
S:Lport.pxPortInitialiseStack$ulAddress$1_0$98({4}SL:U),R,0,0,[r2,r3,r4,r7]
S:Lport.pxPortInitialiseStack$pxStartOfStack$1_0$98({3}DG,SC:U),B,1,12
S:Lport.pxPortInitialiseStack$sloc0$0_1$0({3}DG,SC:U),B,1,1
S:Lport.pxPortInitialiseStack$sloc1$0_1$0({4}SL:U),B,1,4
S:Lport.pxPortInitialiseStack$sloc2$0_1$0({4}SL:U),B,1,8
...
F:G$vTimer0ISR$0_0$0({2}DF,SV:S),Z,0,0,1,1,0
F:Fport$prvSetupTimerInterrupt$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lport.prvSetupTimerInterrupt$ulTicksPerSecond$1_0$125({4}SL:U),R,0,0,[]
S:Lport.prvSetupTimerInterrupt$ulCaptureTime$1_0$125({4}SL:U),R,0,0,[]
S:Lport.prvSetupTimerInterrupt$ulCaptureValue$1_0$125({4}SL:U),R,0,0,[]
S:Lport.prvSetupTimerInterrupt$ucLowCaptureByte$1_0$125({1}SC:U),R,0,0,[]
S:Lport.prvSetupTimerInterrupt$ucHighCaptureByte$1_0$125({1}SC:U),R,0,0,[]
F:G$putchar$0_0$0({2}DF,SV:S),C,0,0,0,0,0
S:Lport.putchar$c$1_0$126({1}SC:U),R,0,0,[r7]
F:G$getchar$0_0$0({2}DF,SC:U),C,0,0,0,0,0
S:Lport.getchar$c$1_0$130({1}SC:U),R,0,0,[r7]
T:Fport$xSTATIC_EVENT_GROUP[({0}S:S$xDummy1$0_0$0({2}SI:U),Z,0,0)({2}S:S$xDummy2$0_0$0({12}STxSTATIC_LIST:S),Z,0,0)]
T:Fport$xSTATIC_TIMER[({0}S:S$pvDummy1$0_0$0({3}DG,SV:S),Z,0,0)({3}S:S$xDummy2$0_0$0({14}STxSTATIC_LIST_ITEM:S),Z,0,0)({17}S:S$xDummy3$0_0$0({2}SI:U),Z,0,0)({19}S:S$uxDummy4$0_0$0({1}SC:U),Z,0,0)({20}S:S$pvDummy5$0_0$0({3}DG,SV:S),Z,0,0)({23}S:S$pvDummy6$0_0$0({2}DC,DF,SV:S),Z,0,0)]
...
T:Fport$xSTATIC_LIST_ITEM[({0}S:S$xDummy1$0_0$0({2}SI:U),Z,0,0)({2}S:S$pvDummy2$0_0$0({12}DA4d,DG,SV:S),Z,0,0)]
...
T:Fport$xSTATIC_TCB[({0}S:S$pxDummy1$0_0$0({3}DG,SV:S),Z,0,0)({3}S:S$xDummy3$0_0$0({28}DA2d,STxSTATIC_LIST_ITEM:S),Z,0,0)({31}S:S$uxDummy5$0_0$0({1}SC:U),Z,0,0)({32}S:S$pxDummy6$0_0$0({3}DG,SV:S),Z,0,0)({35}S:S$ucDummy7$0_0$0({8}DA8d,SC:U),Z,0,0)({43}S:S$pxDummy8$0_0$0({3}DG,SV:S),Z,0,0)({46}S:S$ulDummy18$0_0$0({4}SL:U),Z,0,0)({50}S:S$ucDummy19$0_0$0({1}SC:U),Z,0,0)]
...
T:Fport$xSTATIC_LIST[({0}S:S$uxDummy1$0_0$0({1}SC:U),Z,0,0)({1}S:S$pvDummy2$0_0$0({3}DG,SV:S),Z,0,0)({4}S:S$xDummy3$0_0$0({8}STxSTATIC_MINI_LIST_ITEM:S),Z,0,0)]
...
T:Fport$xSTATIC_MINI_LIST_ITEM[({0}S:S$xDummy1$0_0$0({2}SI:U),Z,0,0)({2}S:S$pvDummy2$0_0$0({6}DA2d,DG,SV:S),Z,0,0)]
...
S:G$getchar$0_0$0({2}DF,SC:U),C,0,0
