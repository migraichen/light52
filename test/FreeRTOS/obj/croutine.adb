M:croutine
T:Fcroutine$xSTATIC_EVENT_GROUP[({0}S:S$xDummy1$0_0$0({2}SI:U),Z,0,0)({2}S:S$xDummy2$0_0$0({12}STxSTATIC_LIST:S),Z,0,0)]
T:Fcroutine$xSTATIC_TIMER[({0}S:S$pvDummy1$0_0$0({3}DG,SV:S),Z,0,0)({3}S:S$xDummy2$0_0$0({14}STxSTATIC_LIST_ITEM:S),Z,0,0)({17}S:S$xDummy3$0_0$0({2}SI:U),Z,0,0)({19}S:S$uxDummy4$0_0$0({1}SC:U),Z,0,0)({20}S:S$pvDummy5$0_0$0({3}DG,SV:S),Z,0,0)({23}S:S$pvDummy6$0_0$0({2}DC,DF,SV:S),Z,0,0)]
T:Fcroutine$xSTATIC_QUEUE[({0}S:S$pvDummy1$0_0$0({9}DA3d,DG,SV:S),Z,0,0)({9}S:S$u$0_0$0({3}ST__00000000:S),Z,0,0)({12}S:S$xDummy3$0_0$0({24}DA2d,STxSTATIC_LIST:S),Z,0,0)({36}S:S$uxDummy4$0_0$0({3}DA3d,SC:U),Z,0,0)({39}S:S$ucDummy5$0_0$0({2}DA2d,SC:U),Z,0,0)]
T:Fcroutine$__00000000[({0}S:S$pvDummy2$0_0$0({3}DG,SV:S),Z,0,0)({0}S:S$uxDummy2$0_0$0({1}SC:U),Z,0,0)]
T:Fcroutine$xLIST_ITEM[({0}S:S$xItemValue$0_0$0({2}SI:U),Z,0,0)({2}S:S$pxNext$0_0$0({3}DG,STxLIST_ITEM:S),Z,0,0)({5}S:S$pxPrevious$0_0$0({3}DG,STxLIST_ITEM:S),Z,0,0)({8}S:S$pvOwner$0_0$0({3}DG,SV:S),Z,0,0)({11}S:S$pvContainer$0_0$0({3}DG,STxLIST:S),Z,0,0)]
T:Fcroutine$xSTATIC_LIST_ITEM[({0}S:S$xDummy1$0_0$0({2}SI:U),Z,0,0)({2}S:S$pvDummy2$0_0$0({12}DA4d,DG,SV:S),Z,0,0)]
T:Fcroutine$xMEMORY_REGION[({0}S:S$pvBaseAddress$0_0$0({3}DG,SV:S),Z,0,0)({3}S:S$ulLengthInBytes$0_0$0({4}SL:U),Z,0,0)({7}S:S$ulParameters$0_0$0({4}SL:U),Z,0,0)]
...
T:Fcroutine$xSTATIC_STREAM_BUFFER[({0}S:S$uxDummy1$0_0$0({8}DA4d,SI:U),Z,0,0)({8}S:S$pvDummy2$0_0$0({9}DA3d,DG,SV:S),Z,0,0)({17}S:S$ucDummy3$0_0$0({1}SC:U),Z,0,0)]
T:Fcroutine$corCoRoutineControlBlock[({0}S:S$pxCoRoutineFunction$0_0$0({2}DC,DF,SV:S),Z,0,0)({2}S:S$xGenericListItem$0_0$0({14}STxLIST_ITEM:S),Z,0,0)({16}S:S$xEventListItem$0_0$0({14}STxLIST_ITEM:S),Z,0,0)({30}S:S$uxPriority$0_0$0({1}SC:U),Z,0,0)({31}S:S$uxIndex$0_0$0({1}SC:U),Z,0,0)({32}S:S$uxState$0_0$0({2}SI:U),Z,0,0)]
T:Fcroutine$tskTaskControlBlock[]
T:Fcroutine$xLIST[({0}S:S$uxNumberOfItems$0_0$0({1}SC:U),Z,0,0)({1}S:S$pxIndex$0_0$0({3}DG,STxLIST_ITEM:S),Z,0,0)({4}S:S$xListEnd$0_0$0({8}STxMINI_LIST_ITEM:S),Z,0,0)]
T:Fcroutine$xMINI_LIST_ITEM[({0}S:S$xItemValue$0_0$0({2}SI:U),Z,0,0)({2}S:S$pxNext$0_0$0({3}DG,STxLIST_ITEM:S),Z,0,0)({5}S:S$pxPrevious$0_0$0({3}DG,STxLIST_ITEM:S),Z,0,0)]
T:Fcroutine$xSTATIC_LIST[({0}S:S$uxDummy1$0_0$0({1}SC:U),Z,0,0)({1}S:S$pvDummy2$0_0$0({3}DG,SV:S),Z,0,0)({4}S:S$xDummy3$0_0$0({8}STxSTATIC_MINI_LIST_ITEM:S),Z,0,0)]
T:Fcroutine$HeapRegion[({0}S:S$pucStartAddress$0_0$0({3}DG,SC:U),Z,0,0)({3}S:S$xSizeInBytes$0_0$0({2}SI:U),Z,0,0)]
...
T:Fcroutine$xSTATIC_MINI_LIST_ITEM[({0}S:S$xDummy1$0_0$0({2}SI:U),Z,0,0)({2}S:S$pvDummy2$0_0$0({6}DA2d,DG,SV:S),Z,0,0)]
...
T:Fcroutine$xTIME_OUT[({0}S:S$xOverflowCount$0_0$0({1}SC:S),Z,0,0)({1}S:S$xTimeOnEntering$0_0$0({2}SI:U),Z,0,0)]
...
S:G$xCoRoutineCreate$0_0$0({2}DF,SC:S),C,0,0
S:G$vCoRoutineSchedule$0_0$0({2}DF,SV:S),C,0,0
S:G$vCoRoutineAddToDelayedList$0_0$0({2}DF,SV:S),C,0,0
S:G$xCoRoutineRemoveFromEventList$0_0$0({2}DF,SC:S),C,0,0
