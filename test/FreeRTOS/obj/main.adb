...
F:G$main$0_0$0({2}DF,SI:S),C,0,0,0,0,0
F:Fmain$prvSetupHardware$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$ATaskFunction$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lmain.ATaskFunction$pvParameters$1_0$96({3}DG,SV:S),R,0,0,[r5,r6,r7]
S:Lmain.ATaskFunction$pcTaskName$1_0$97({3}DG,SC:U),R,0,0,[r5,r6,r7]
F:G$ATaskFunction2$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lmain.ATaskFunction2$pvParameters$1_0$99({3}DG,SV:S),R,0,0,[r5,r6,r7]
S:Lmain.ATaskFunction2$pcTaskName$1_0$100({3}DG,SC:U),R,0,0,[r5,r6,r7]
S:Lmain.ATaskFunction2$ucRx$1_0$100({1}SC:U),R,0,0,[r6]
T:Fmain$xSTATIC_EVENT_GROUP[({0}S:S$xDummy1$0_0$0({2}SI:U),Z,0,0)({2}S:S$xDummy2$0_0$0({12}STxSTATIC_LIST:S),Z,0,0)]
T:Fmain$xSTATIC_TIMER[({0}S:S$pvDummy1$0_0$0({3}DG,SV:S),Z,0,0)({3}S:S$xDummy2$0_0$0({14}STxSTATIC_LIST_ITEM:S),Z,0,0)({17}S:S$xDummy3$0_0$0({2}SI:U),Z,0,0)({19}S:S$uxDummy4$0_0$0({1}SC:U),Z,0,0)({20}S:S$pvDummy5$0_0$0({3}DG,SV:S),Z,0,0)({23}S:S$pvDummy6$0_0$0({2}DC,DF,SV:S),Z,0,0)]
T:Fmain$xSTATIC_QUEUE[({0}S:S$pvDummy1$0_0$0({9}DA3d,DG,SV:S),Z,0,0)({9}S:S$u$0_0$0({3}ST__00000000:S),Z,0,0)({12}S:S$xDummy3$0_0$0({24}DA2d,STxSTATIC_LIST:S),Z,0,0)({36}S:S$uxDummy4$0_0$0({3}DA3d,SC:U),Z,0,0)({39}S:S$ucDummy5$0_0$0({2}DA2d,SC:U),Z,0,0)]
T:Fmain$__00000000[({0}S:S$pvDummy2$0_0$0({3}DG,SV:S),Z,0,0)({0}S:S$uxDummy2$0_0$0({1}SC:U),Z,0,0)]
T:Fmain$xLIST_ITEM[({0}S:S$xItemValue$0_0$0({2}SI:U),Z,0,0)({2}S:S$pxNext$0_0$0({3}DG,STxLIST_ITEM:S),Z,0,0)({5}S:S$pxPrevious$0_0$0({3}DG,STxLIST_ITEM:S),Z,0,0)({8}S:S$pvOwner$0_0$0({3}DG,SV:S),Z,0,0)({11}S:S$pvContainer$0_0$0({3}DG,STxLIST:S),Z,0,0)]
T:Fmain$xSTATIC_LIST_ITEM[({0}S:S$xDummy1$0_0$0({2}SI:U),Z,0,0)({2}S:S$pvDummy2$0_0$0({12}DA4d,DG,SV:S),Z,0,0)]
T:Fmain$xMEMORY_REGION[({0}S:S$pvBaseAddress$0_0$0({3}DG,SV:S),Z,0,0)({3}S:S$ulLengthInBytes$0_0$0({4}SL:U),Z,0,0)({7}S:S$ulParameters$0_0$0({4}SL:U),Z,0,0)]
T:Fmain$xSTATIC_TCB[({0}S:S$pxDummy1$0_0$0({3}DG,SV:S),Z,0,0)({3}S:S$xDummy3$0_0$0({28}DA2d,STxSTATIC_LIST_ITEM:S),Z,0,0)({31}S:S$uxDummy5$0_0$0({1}SC:U),Z,0,0)({32}S:S$pxDummy6$0_0$0({3}DG,SV:S),Z,0,0)({35}S:S$ucDummy7$0_0$0({8}DA8d,SC:U),Z,0,0)({43}S:S$pxDummy8$0_0$0({3}DG,SV:S),Z,0,0)({46}S:S$ulDummy18$0_0$0({4}SL:U),Z,0,0)({50}S:S$ucDummy19$0_0$0({1}SC:U),Z,0,0)]
T:Fmain$xSTATIC_STREAM_BUFFER[({0}S:S$uxDummy1$0_0$0({8}DA4d,SI:U),Z,0,0)({8}S:S$pvDummy2$0_0$0({9}DA3d,DG,SV:S),Z,0,0)({17}S:S$ucDummy3$0_0$0({1}SC:U),Z,0,0)]
T:Fmain$tskTaskControlBlock[]
T:Fmain$xLIST[({0}S:S$uxNumberOfItems$0_0$0({1}SC:U),Z,0,0)({1}S:S$pxIndex$0_0$0({3}DG,STxLIST_ITEM:S),Z,0,0)({4}S:S$xListEnd$0_0$0({8}STxMINI_LIST_ITEM:S),Z,0,0)]
T:Fmain$xMINI_LIST_ITEM[({0}S:S$xItemValue$0_0$0({2}SI:U),Z,0,0)({2}S:S$pxNext$0_0$0({3}DG,STxLIST_ITEM:S),Z,0,0)({5}S:S$pxPrevious$0_0$0({3}DG,STxLIST_ITEM:S),Z,0,0)]
T:Fmain$xSTATIC_LIST[({0}S:S$uxDummy1$0_0$0({1}SC:U),Z,0,0)({1}S:S$pvDummy2$0_0$0({3}DG,SV:S),Z,0,0)({4}S:S$xDummy3$0_0$0({8}STxSTATIC_MINI_LIST_ITEM:S),Z,0,0)]
T:Fmain$HeapRegion[({0}S:S$pucStartAddress$0_0$0({3}DG,SC:U),Z,0,0)({3}S:S$xSizeInBytes$0_0$0({2}SI:U),Z,0,0)]
T:Fmain$xTASK_STATUS[({0}S:S$xHandle$0_0$0({3}DG,STtskTaskControlBlock:S),Z,0,0)({3}S:S$pcTaskName$0_0$0({3}DG,SC:U),Z,0,0)({6}S:S$xTaskNumber$0_0$0({1}SC:U),Z,0,0)({7}S:S$eCurrentState$0_0$0({1}SC:U),Z,0,0)({8}S:S$uxCurrentPriority$0_0$0({1}SC:U),Z,0,0)({9}S:S$uxBasePriority$0_0$0({1}SC:U),Z,0,0)({10}S:S$ulRunTimeCounter$0_0$0({4}SL:U),Z,0,0)({14}S:S$pxStackBase$0_0$0({3}DG,SC:U),Z,0,0)({17}S:S$usStackHighWaterMark$0_0$0({2}SI:U),Z,0,0)]
T:Fmain$xSTATIC_MINI_LIST_ITEM[({0}S:S$xDummy1$0_0$0({2}SI:U),Z,0,0)({2}S:S$pvDummy2$0_0$0({6}DA2d,DG,SV:S),Z,0,0)]
T:Fmain$xTASK_PARAMETERS[({0}S:S$pvTaskCode$0_0$0({2}DC,DF,SV:S),Z,0,0)({2}S:S$pcName$0_0$0({3}DG,SC:U),Z,0,0)({5}S:S$usStackDepth$0_0$0({2}SI:U),Z,0,0)({7}S:S$pvParameters$0_0$0({3}DG,SV:S),Z,0,0)({10}S:S$uxPriority$0_0$0({1}SC:U),Z,0,0)({11}S:S$puxStackBuffer$0_0$0({3}DG,SC:U),Z,0,0)({14}S:S$xRegions$0_0$0({11}DA1d,STxMEMORY_REGION:S),Z,0,0)]
T:Fmain$xTIME_OUT[({0}S:S$xOverflowCount$0_0$0({1}SC:S),Z,0,0)({1}S:S$xTimeOnEntering$0_0$0({2}SI:U),Z,0,0)]
S:G$block$0_0$0({2}SI:U),F,0,0
S:Lmain.main$pcTextForTask1$1_0$93({3}DG,SC:U),F,0,0
S:Lmain.main$pcTextForTask2$1_0$93({3}DG,SC:U),F,0,0
...
S:Fmain$__str_0$0_0$0({7}DA7d,SC:U),D,0,0
S:Fmain$__str_1$0_0$0({7}DA7d,SC:U),D,0,0
S:Fmain$__str_2$0_0$0({3}DA3d,SC:U),D,0,0
S:Fmain$__str_3$0_0$0({43}DA43d,SC:U),D,0,0
S:Fmain$__str_4$0_0$0({17}DA17d,SC:U),D,0,0
S:Fmain$__str_5$0_0$0({10}DA10d,SC:U),D,0,0
S:Fmain$__str_6$0_0$0({7}DA7d,SC:U),D,0,0
S:Fmain$__str_7$0_0$0({16}DA16d,SC:U),D,0,0
S:Fmain$__str_8$0_0$0({3}DA3d,SC:U),D,0,0
