...
S:Lblinker.main$msecs$1_0$23({4}SL:U),R,0,0,[r4,r5,r6,r7]
S:Lblinker.main$secs$1_0$23({4}SL:U),R,0,0,[r4,r5,r6,r7]
...
S:G$soc_init$0_0$0({2}DF,SV:S),C,0,0
S:G$soc_get_msecs$0_0$0({2}DF,SL:U),C,0,0
S:G$cpu_enable_interrupts$0_0$0({2}DF,SV:S),C,0,0
S:G$timer0_init$0_0$0({2}DF,SV:S),C,0,0
S:G$timer0_enable$0_0$0({2}DF,SV:S),C,0,0
S:G$timer0_counter$0_0$0({2}DF,SI:U),C,0,0
S:G$timer0_enable_irq$0_0$0({2}DF,SV:S),C,0,0
S:G$timer0_isr$0_0$0({2}DF,SV:S),C,0,0
S:G$main$0_0$0({2}DF,SV:S),C,0,0
S:Fblinker$__str_0$0_0$0({3}DA3d,SC:U),D,0,0
S:Fblinker$__str_1$0_0$0({34}DA34d,SC:U),D,0,0
S:Fblinker$__str_2$0_0$0({20}DA20d,SC:U),D,0,0
